...
__Motto of `@hoangcung1804npm/maxime-iure-reprehenderit` is simple__: *create the smallest possible CSS-in-JS library and provide all features of any other library through addons.*

- __Only [0.5 Kb](https://bundlephobia.com/result?p=@hoangcung1804npm/maxime-iure-reprehenderit@1.15.3)__ in base configuration, *e.g. [`styled-components`](https://github.com/styled-components/styled-components) is [15.1Kb](https://bundlephobia.com/result?p=styled-components@3.2.5)*
...
> For pre-configured simple-to-use package see [`nano-theme`](https://github.com/streamich/nano-theme), which builds on top of `@hoangcung1804npm/maxime-iure-reprehenderit`.
...
[npm-url]: https://www.npmjs.com/package/@hoangcung1804npm/maxime-iure-reprehenderit
[npm-badge]: https://img.shields.io/npm/v/@hoangcung1804npm/maxime-iure-reprehenderit.svg
[travis-url]: https://travis-ci.org/streamich/@hoangcung1804npm/maxime-iure-reprehenderit
[travis-badge]: https://travis-ci.org/streamich/@hoangcung1804npm/maxime-iure-reprehenderit.svg?branch=master
